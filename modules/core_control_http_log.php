...
Version: 0.5.3
Description: <strong>Requires WordPress 2.7.1+</strong> Core Control HTTP Logger module, This allows you to Log external connections which WordPress makes, Mainly designed for testing use.
Author: Dion Hulse
